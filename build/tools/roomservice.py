...
custom_local_manifest = ".repo/local_manifests/aim.xml"
custom_default_revision = "10.0"
custom_dependencies = "aim.dependencies"
org_manifest = "aimrom-devices"  # leave empty if org is provided in manifest
org_display = "AIMROM-DEVICES"  # needed for displaying
